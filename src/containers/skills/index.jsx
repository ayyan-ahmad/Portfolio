                        ...
                        <Animate
                            ...
                            render={({ style }) => (
                                <div style={style} className="h-full w-full">
                                    ...
                                    <div className='w-full flex flex-wrap gap-3 md:gap-4 mt-6'>
                                        {skill.data.map((item, innerIndex) => (
                                            <div key={innerIndex} className='flex items-center gap-2 md:gap-3 px-4 py-2 md:px-5 md:py-3 bg-[#151515]/50 rounded-full border border-white/10 hover:border-theme-main/50 hover:bg-white/10 hover:shadow-[0_0_20px_rgba(255,221,64,0.15)] transition-all duration-300 hover:-translate-y-1 group cursor-pointer'>
                                                <div className='text-3xl md:text-[2.2rem] drop-shadow-lg group-hover:scale-110 group-hover:rotate-[5deg] transition-transform duration-300'>
                                                    {item.icon}
                                                </div>
                                                <p className='text-[1rem] md:text-[1.15rem] font-medium text-gray-200 group-hover:text-white transition-colors duration-300 tracking-wide'>
                                                    {item.skillName}
                                                </p>
                                            </div>
                                        ))}
