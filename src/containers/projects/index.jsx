...
const projectData = [
...

    {
        ...
        techStack: ["EJS", "Bootstrap", "CSS", "Node.js", "Express", "MongoDB"],
        image: image1,
    ...
    },
    {
        id: 6,
        name: "Todo App",
        description: "A simple Todo List application built using React with features like add, delete, mark as done, and mark all tasks as completed.",
        techStack: ["React", "CSS"],
        image: image7,
        link: 'https://todo-ap-react.netlify.app/',
        github: 'https://github.com/ayyan-ahmad/React-Todo-app',
        filterId: 3
                                ...
                                <div className='flex flex-col bg-[#1e1e24]/80 backdrop-blur-sm border border-white/5 rounded-2xl overflow-hidden shadow-lg hover:shadow-[0_10px_30px_rgba(255,221,64,0.1)] transition-all duration-500 hover:-translate-y-2 group h-full'>
                                    ...
                                    <div className='h-[220px] w-full overflow-hidden relative border-b border-white/10'>
                                        <a href={item.link} target="_blank" rel='noopener noreferrer' className="h-full w-full block">
                                            <img src={item.image} alt={item.name} className="h-full w-full object-cover object-top transition-transform duration-700 group-hover:scale-110" />
                                        </a>
